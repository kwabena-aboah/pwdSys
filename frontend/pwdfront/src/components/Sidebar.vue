            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <router-link to="/disability-type" class="nav-link">Disability Type</router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/service_type" class="nav-link">Service Type</router-link>
                        </li>
                    </ul>
                    ...
                    <ul class="nav flex-column mb-2">
                      <li class="nav-item">
                        <router-link to="/verify-document" class="nav-link">Verify Document</router-link>
                      </li>
                      <li class="nav-item">
                        <router-link to="/verify-upload" class="nav-link">Verify Upload</router-link>
                      </li>
                    </ul>
                </div>
            </nav>
